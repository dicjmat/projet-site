<%@ Page Title="Réinitialiser le mot de passe" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.vb" Inherits="ProjetSite.ResetPassword" Async="true" %>
